  ...
  <body>
    <form class="form-signin">
      ...
      <div class="form-label-group">
        <input type="text" id="loginid" class="form-control" placeholder="ID를 입력해주세요."  autofocus>
      </div>

      <div class="form-label-group">
        <input type="password" id="loginpswd" class="form-control" placeholder="Password를 입력해 주세요."  >
      </div>
      ...
      <button class="btn btn-lg btn-outline-dark btn-block" type="button" onclick="location.href='signupmain.html' " id="btnsignup">SIGNUP</button>
      <hr>
      ...
      <p id="findmyid">
      	<a href="find.html"  id="find" >아이디/비밀번호 찾기</a> 
      </p>
