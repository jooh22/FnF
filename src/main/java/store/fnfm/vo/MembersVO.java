...
public class MembersVO {
	...
	public String toString() {
		return "MemberVO [user_id=" + user_id + ", email=" + email + ", password=" + password + ", user_name="
	...
	/*public MemberVO(String user_id, String email, String password, String user_name, String phone, String birth,
			String question, String answer, int status, String authority, String regi_num, String com_name,
			String com_url, int mile_total, int mile_used, int mile_remain) {
		this.user_id = user_id;
		this.email = email;
		this.password = password;
		this.user_name = user_name;
