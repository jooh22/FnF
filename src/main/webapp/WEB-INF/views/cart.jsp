...
<div class="container">
	...
	<table class="table">
		<td>선택상품을 &nbsp;
			 <input type="submit" class="btn btn-outline-success btn-sm" onclick="javascript: form.action='/selectdel/';" value="삭제하기"/></td>
			 <td class="text-right">
	...
	<div class="text-center">
				<c:choose>
    					<c:when test="${map.count == 0}">
   									 ...
   									 <c:otherwise>
      									<input type="button" class="btn" id="btnOrder" value="주문하기" />&nbsp;&nbsp;&nbsp;
    								</c:otherwise>
						</c:choose>
