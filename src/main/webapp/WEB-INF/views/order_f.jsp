	...
	<div class="container" >
		<table class="table table-sm text-center border bg-light">
			<tr>
				...
				<span>주문내역 및 배송에 관한 안내는 <a href="/myshop/order/list.html">주문조회</a>
    		...
    		<table class="table  table-sm table-bordered td">
    			<tr>
    				<td class="align-middle active">최종결제금액</td><td><div>${vo.totalprice}원</div></td>
    			</tr>
    			<tr>
		...
		<table class="table text-center h4">
			 	...
			 	<tr class="h4">
			 		<td>${productSum}</td><td>+${vo.del_price}</td><td>-${vo.mile_used}</td><td class="text-primary">${vo.totalprice}원</td>
			 	</tr>
			 </table>
		...
		<div  class="text-center">
			<input type="button" class="btn btn-dark" value="주문확인하기 " onclick="location.href='mypage.jsp'">&nbsp;&nbsp;&nbsp;
