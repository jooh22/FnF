...
<!-- 	</div> -->
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
			                                	<input type="submit" class="btn btn-default" style="padding:10px 20px" onclick="javascript: form.action='/cart_order';" value="바로구매">
			                                	<input type="submit" class="btn btn-default" style="padding:10px 20px" onclick="javascript: form.action='/update';" value="장바구니">
